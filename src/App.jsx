...
export default function App() {
  ...
  const text = {
    ...
    PA: { gearClearDay: "گیئر: سن گلاسز", gearClearNight: "گیئر: جیکٹ", gearRain: "گیئر: چھتری", searchPlaceholder: "کیمپس تلاش کریں...", optionsTitle: "ترتیبات", langPrefTitle: "زبان", primaryLangLabel: "بنیادی زبان", secondaryLangLabel: "ثانوی زبان", studentProfile: "پروفائل", manageId: "شناخت کا انتظام", notifications: "اطلاعات", weatherAlerts: "موسمی انتباہات", mapTitle: "نقشہ", mapComingSoon: "فیز 2 میں آ رہا ہے!", themeTitle: "تھیم", themeDesc: "حسب ضرورت بنائیں", themeDynamic: "ڈائنامک (موسم)", themeMidnight: "مڈنائٹ ڈارک", themeSunset: "سن سیٹ گلو", themeQMUL: "QMUL نیلا", themeForest: "فارسٹ گرین", themeProtanopia: "پروٹانوپیا (سرخ اندھا)", themeDeuteranopia: "ڈیوٹرانوپیا (سبز اندھا)", themeTritanopia: "ٹرائٹانوپیا (نیلا اندھا)", previewTitle: "لائیو پیش نظارہ", themeCustom: "کسٹم تھیم", bgClear: "صاف", bgCloudy: "ابر آلود", bgFog: "دھند", bgRain: "بارش", bgSnow: "برف", bgThunder: "گرج چمک", dayStr: "دن", nightStr: "رات", styleSun: "سورج آئیکن", styleMoon: "چاند آئیکن", styleCloudy: "ابر آلود آئیکن", styleFog: "دھند آئیکن", styleRain: "بارش آئیکن", styleSnow: "برف آئیکن", styleThunder: "گرج چمک آئیکن", tapToToggle: "تبدیل کرنے کے لیے ٹیپ کریں", bgColors: "پس منظر", elementColors: "عناصر", colorSun: "سورج", colorMoon: "چاند", colorRain: "بارش", colorCloud: "بادل", colorFog: "دھند", colorSnow: "برف", colorThunder: "گرج چمک", colorText: "متن", colorNavSelected: "نیویگیشن", modeTitle: "موڈ", modeSimple: "سادہ", modeComplex: "پیچیدہ", modeBattery: "بیٹری سیور", humidity: "نمی", wind: "ہوا", uv: "یو وی", pollution: "آلودگی", pressure: "دباؤ", sunrise: "طلوع آفتاب", sunset: "غروب آفتاب", sizesTitle: "سائز", sizeFlag: "پرچم", sizeTemp: "درجہ حرارت", sizeWeather: "موسم", sizeText: "متن", sizeNav: "نیویگیشن", sizeTopTemp: "اوپری درجہ حرارت", forecastTitle: "7 دن کی پیش گوئی", descClear: "صاف", descCloudy: "ابر آلود", descFog: "دھند", descRain: "بارش", descSnow: "برف", descThunder: "گرج چمک", gearSnow: "گیئر: بھاری کوٹ", gearThunder: "گیئر: گھر میں رہیں", simpleForecastTitle: "اس ہفتے", fillIcon: "آئیکن بھریں", sizeComplexGrid: "پیچیدہ گرڈ", sizeForecast: "پیش گوئی کا سائز", mapYourLocation: "آپ کی جگہ", mapYouAreHere: "آپ یہاں ہیں!", mapCurrentUni: "موجودہ یونیورسٹی", mapLocAccessReq: "مقام تک رسائی درکار ہے", mapDistanceTo: "فاصلہ", mapTip: "💡 مشورہ: مختلف یوکے یونیورسٹیوں کو دریافت کرنے کے لیے ہوم پیج پر سرچ بار استعمال کریں۔ نقشہ ہر کیمپس کا مقام دکھانے کے لیے اپڈیٹ ہوگا!", mapGettingLoc: "آپ کا مقام حاصل کیا جا رہا ہے...", mapFailLoad: "نقشہ لوڈ کرنے میں ناکام", mapRetry: "دوبارہ کوشش کریں", themeDisabledTitle: "تھیم غیر فعال", themeDisabledDesc: "آپ اس وقت بیٹری سیور موڈ میں ہیں۔ اپنی تھیم کو حسب ضرورت بنانے کے لیے، براہ کرم ترتیبات میں واپس جا کر سادہ یا پیچیدہ موڈ منتخب کریں۔", backToSettings: "ترتیبات پر واپس جائیں", themeAchromatopsia: "اکرومیٹوپسیا (سیاہ و سفید)", themeColorful: "رنگین", categoryDynamic: "ڈائنامک تھیم", categoryMonotone: "مونوٹون تھیم", categoryAccessibility: "قابل رسائی تھیم", categoryCustom: "کسٹم تھیم" }
  };
